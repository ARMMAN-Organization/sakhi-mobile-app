...
private const val ONE_TIME_WORK_NAME = "ad_hoc_form_drafts"
private const val BACKOFF_DELAY_SECONDS = 30L

/**
 * Schedules [AdHocFormSyncWorker] runs — the CR-026b sixth offline queue, alongside the other five.
 * Same interface-vs-concrete-class split as those, for the same reason (no Robolectric here).
 *
 ...
 * [RoomAdHocFormDraftRepository] makes while already online. Nothing schedules this on a timer,
 * app start, or reconnect.
 */
interface AdHocFormSyncScheduler {
...
@Singleton
class WorkManagerAdHocFormSyncScheduler @Inject constructor(
  private val workManager: WorkManager,
) : AdHocFormSyncScheduler {
  ...
  override fun syncNow() {
    val request = OneTimeWorkRequestBuilder<AdHocFormSyncWorker>()
